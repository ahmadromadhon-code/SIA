...
-- Sesuai dengan struktur database: admin, guru, jadwal, kelas, mapel, nilai, presensi, siswa, tahun_ajaran
...
-- Insert data kelas (sesuai struktur database yang ada)
...
-- Insert data tahun ajaran (sesuai struktur database yang ada)
